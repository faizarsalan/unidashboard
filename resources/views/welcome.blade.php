...
<div class="background1" style="background-image:url(../storage/background1.png); background-size: 100% 100%;display:flex;">
...
<div class="joinUS" id="team" style="
    ...
    <a class="btn" style="background-color: rgba(200,160,160,255);color:white;font-size:1.5vw;padding: 0.5vw 5vw" href="/register" role="button">JOIN US</a>
</div>
...
font-style: normal">
    ...
    <div class="embed-responsive embed-responsive-16by9">
        <iframe class="embed-responsive-item" width="300" height="150" src="https://www.youtube.com/embed/TLahQwBlK6g" frameborder="1" allowfullscreen></iframe>
    </div>
</div>
